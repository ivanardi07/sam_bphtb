...
class Register extends CI_Controller
{
	...
	public function add_user()
	{
		...
		//TESTING PERCOBAAN UPLOAD
		$folder_temp    		 = 'assets/files/ktp_temp/';
		$config['upload_path']   = $folder_temp;
		...
		if (!$this->upload->do_upload('foto')) {
			...
			if (file_exists(FCPATH . "/assets/files/ktp_temp/" . $upload_data['file_name'])) {
				unlink(FCPATH . "/assets/files/ktp_temp/" . $upload_data['file_name']);
			}
		}
