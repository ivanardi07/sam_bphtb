        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="panel-title" style="margin-left: 0;"><a href="<?php echo $c_loc; ?>">SSPD - BPHTB</a></h3>
                        </div>
                        <div class="col-md-6"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <small>Surat Setoran Pajak Daerah - Bea Perolehan Hak atas Tanah dan Bangunan</small>
                ...
                <div class="panel-body">
                    ...
                    <div class="inputform">
                        <form enctype="multipart/form-data" name="frm_sptpd" method="post" action="" onsubmit="return check_add_sptpd();" id="frm_sptpd">
                            ...
                            <div class="form-group">
                                ...
                                <div class="cols-sm-10">
                                    <div class="input-group">
                                        <span>Input dengan tanda (*) wajib diisi!</span>
                                    </div>
                                </div>
                            </div>
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td>
                                        <select name="id_ppat" class="form-control select2" style="width: 220px;">
                                            <option value=""></option>
                                            <?php foreach ($ppat as $key => $value) : ?>
                                                <option value="<?php echo $value->id_ppat; ?>">
                                                    <?= $value->nama ?>
                                                </option>
                                            <?php endforeach ?>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td width="25">: </td>
                                    <td>
                                        <input class="form-control pull-left" type="text" name="txt_id_nik_sptpd" id="id_nik_id" onchange="lookup_nik($(this).val());" style="width: 220px;" maxlength="30" value="<?php echo @$isi->nik; ?>" <?php if ($submitvalue == 'Edit') {
                                ...
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td>
                                        <input type="text" class="form-control" id="nama_nik_id_text" name="nama_nik_name" style="width: 220px;" value="<?php echo @$isi->nama; ?>">
                                        <span id="nama_nik_id"><?php echo @$isi->nama; ?></span> <br>
                                        <input type="checkbox" style="margin-right: 2px;" name="wajibpajak" id="wajibpajak" value="CS">CS
                                        <input type="checkbox" style="margin-left: 10px;margin-bottom: 10px;margin-top: 10px; margin-right: 2px;" name="wajibpajak" id="wajibpajak2" value="QQ">QQ
                                        <input type="checkbox" style="margin-left: 10px;margin-bottom: 10px;margin-top: 10px; margin-right: 2px;" name="wajibpajak" id="wajibpajak3" value="">Lainnya
                                        <input type="text" class="form-control" style="width: 220px;" name="wajibpajaktext" id="wajibpajaktext" placeholder="Input QQ">
                                        <input type="text" class="form-control" style="width: 220px;" name="wajibpajaklainnya" id="wajibpajaklainnya" placeholder="Lainnya">
                                        <script type="text/javascript">
                                            $("#wajibpajaktext").hide();
                                            $("#wajibpajaklainnya").hide();
                                            $("input[name=wajibpajak]").click(function() {
                                                var wasChecked = !$(this).prop("checked");
                                                $("input[name=wajibpajak]").prop("checked", false);
                                                $(this).prop("checked", (!wasChecked) ? true : false);
                                                if ($("#wajibpajak").attr('checked')) {
                                                    $("#wajibpajaktext").hide();
                                                    $("#wajibpajaklainnya").hide();
                                                } else if ($("#wajibpajak2").attr('checked')) {
                                                    $("#wajibpajaktext").show();
                                                    $("#wajibpajaklainnya").hide();
                                                } else if ($("#wajibpajak3").attr('checked')) {
                                                    $("#wajibpajaklainnya").show();
                                                    $("#wajibpajaktext").hide();
                                                } else {
                                                    $("#wajibpajaktext").hide();
                                                    $("#wajibpajaklainnya").hide();
                                ...
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td><input type="text" class="form-control" id="alamat_nik_id_text" name="alamat_nik_name" style="width: 220px;" value="<?php echo @$isi->alamat; ?>">
                                        <span id="alamat_nik_id"><?php echo @$isi->alamat; ?></span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td>
                                        <input type="text" class="form-control" id="propinsi_nik_id_text" name="propinsi_nik_name" style="width: 220px;" value="<?php echo @$propinsi->nama; ?>">
                                        <span id="propinsi_nik_id"><?php echo @$propinsi->nama; ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td>
                                        <input type="text" class="form-control" id="kotakab_nik_id_text" name="kotakab_nik_name" style="width: 220px;" value="<?php echo @$kabupaten->nama; ?>">
                                        <span id="propinsi_nik_id"><?php echo @$kabupaten->nama; ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td> Kecamatan </td>
                                    <td>:</td>
                                    <td>
                                        <input type="text" class="form-control" id="kecamatan_nik_id_text" name="kecamatan_nik_name" style="width: 220px;" value="<?php echo @$kecamatan->nama; ?>">
                                        <span id="kecamatan_nik_id"><?php echo @$kecamatan->nama; ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <input type="text" class="form-control" id="kelurahan_nik_id_text" name="kelurahan_nik_name" style="width: 220px;" value="<?php echo @$kelurahan->nama; ?>">
                                        <span id="kelurahan_nik_id"><?php echo @$kelurahan->nama; ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td> RT / RW </td>
                                    <td>: </td>
                                    <td> <input type="text" class="form-control" id="rtrw_nik_id_text" name="rtrw_nik_name" style="width: 220px;" value="<?php echo @$isi->rtrw; ?>"><span id="rtrw_nik_id"><?php echo @$isi->rtrw; ?></span> </td>
                                </tr>
                                <tr>
                                    <td> Kode Pos </td>
                                    <td>: </td>
                                    <td> <input type="text" class="form-control" id="kodepos_nik_id_text" name="kodepos_nik_name" style="width: 220px;" value="<?php echo @$isi->kodepos; ?>"><span id="kodepos_nik_id"><?php echo @$isi->kodepos; ?></span> </td>
                                </tr>
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($submitvalue != 'Edit') { ?><a style="float: left; margin-left: 10px;" class="btn btn-default" href="javascript:void(0)" onclick="lookup_nop($(this).val(), $('#id_nik_id').val());" style="cursor:pointer">Detail</a> <b id="nop_error" style="background-color:#800;color:#fff;margin-left:20px;padding:0 10px;display:none"></b><?php } ?>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td>
                                        <select class="form-control select2 sel_jml_bangunan" name="sel_jml_bangunan" style="width: 220px;" disabled>
                                            <?php for ($i = 0; $i <= 10; $i++) : ?>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <button type="button" class="btn btn-primary btn-showFormLSPOP hide" data-toggle="modal" data-target="#modalFormLSPOP">LSPOP</button>
                                        <input type="hidden" name="lspopdata" />
                                    </td>
                                </tr>
                                <!-- <tr>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="npop_aphb">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3"><span style="display:none" id="luas_tanah_nop_id"><?php echo @$nop->luas_tanah_op; ?></span>
                                        ...
                                        <tr align="right">
                                                ...
                                                <div class="npop_aphb">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3"><span style="display:none" id="luas_bangunan_nop_id"><?php echo @$nop->luas_bangunan_op; ?></span>
                                                            <input class="form-control pull-right" onkeypress="return isNumberKey(event)" style="width: 55px;" type="text" name="txt_luas_bangunan_sptpd" id="luas_bangunan_id" onkeyup="count_bangunan_add_sptpd_2();" value="<?php echo @$nop->luas_bangunan_op; ?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <input class="form-control pull-right" style="width: 150px;" type="text" name="txt_njop_bangunan_sptpd" id="njop_bangunan_id" value="<?php echo @$nop->njop_bangunan_op; ?>" class="tb" onkeypress="return isNumberKey(event)" onkeyup="count_bangunan_add_sptpd_2();" />
                                                <p class="pull_right">Rp.&nbsp;&nbsp;</p>
                                            </td>
                                            <td align="right">
                        ...
                        <td colspan = '4'>
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td> Nomor Sertipikat / Nomor Bukti Pemilik *</td>
                                    <td>: </td>
                                    <td>
                                        <select class="select2 jbk" onchange="jenisAction($('#jns_perolehan_op_id').val());" name="txt_jns_kepemilikan_sptpd">
                                            <!-- <option value="">Jenis Bukti Kepemilikan</option> -->
                                            <option value="shm">(SHM) Sertifikat Hak Milik</option>
                                            <option value="hgb">(HGB) Hak Guna Bangunan</option>
                                            <option value="lc">Letter C</option>
                                        </select>
                                        <input type="text" style="width: 300px;" name="txt_no_sertifikat_op" class="form-control pull-left">
                                        <p class="pull-left">&nbsp;&nbsp;*</p>
                                    </td>
                                </tr>
                            </table>
                            <div class="listform" style="margin: 10px 0;">
                                <table class="table table-hover">
                                    <thead>
                                        <tr class="tblhead">
                                            <th colspan="2" class="text-center"> PENGHITUNGAN BPHTB (Hanya diisi berdasarkan penghitungan Wajib)</th>
                        ...
                        <td align="right" colspan="2">
                            ...
                            <?php endif; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" colspan="2">
                                                <?php if ($cek_transaksi_prev) : ?>
                                                    <input class="form-control pull-right" type="text" name="txt_npoptkp_sptpd" id="npoptkp_id" style="width: 150px; text-align:right;" value="<?php echo number_format($this->config->item('conf_npoptkp_60'), 0, ',', '.') ?>" onkeyup="count_npoptkp($(this).val());" readonly />
                                                    <p class="pull-right">Rp.&nbsp;&nbsp;</p>
                                                    <!--                             Rp. <span id="npoptkp_lbl_id"><?php echo number_format($this->config->item('conf_npoptkp_60'), 0, ',', '.'); ?></span>
                            <input type="hidden" name="txt_npoptkp_sptpd" id="npoptkp_id" value="<?php echo $this->config->item('conf_npoptkp_60'); ?>" /> -->
                                                <?php else : ?>
                                ...
                                <table class="table table-hover">
                                    <tr>
                                        <td style="width: 270px;">
                                            <label for="pwp_id"><input type="checkbox" name="txt_dasar_jml_setoran_sptpd" id="pwp_id" value="PWP" <?php if (@$sptpd->jns_setoran == 'PWP') {
                                    ...
                                    <tr>
                                        <td><label for="stb_id">
                                                <input type="checkbox" name="txt_dasar_jml_setoran_sptpd" id="stb_id" value="STB" <?php if (@$sptpd->jns_setoran == 'STB') {
                                                                                                                                        echo 'checked="checked"';
                                                                                                                                    } ?> /> STPD
                                            </label>
                                        </td>
                                    ...
                                    <tr>
                                        <td><label for="skbkb_id">
                                                <input type="checkbox" name="txt_dasar_jml_setoran_sptpd" id="skbkb_id" value="SKBKB" <?php if (@$sptpd->jns_setoran == 'SKBKB') {
                                                                                                                                            echo 'checked="checked"';
                                                                                                                                        } ?> /> SKPDKB
                                            </label>
                                        </td>
                                    ...
                                    <tr>
                                        <td><label for="skbkbt_id">
                                                <input type="checkbox" name="txt_dasar_jml_setoran_sptpd" id="skbkbt_id" value="SKBKBT" <?php if (@$sptpd->jns_setoran == 'SKBKBT') {
                                                                                                                                            echo 'checked="checked"';
                                                                                                                                        } ?> /> SKPDKBT
                                            </label>
                                        </td>
                                    ...
                                    <tr>
                                        <td><label for="pds_id">
                                                <input type="checkbox" name="txt_dasar_jml_setoran_sptpd" id="pds_id" value="PDS" <?php if (@$sptpd->jns_setoran == 'PDS') {
                                                                                                                                        echo 'checked="checked"';
                            ...
                            <div style="margin: 10px 0;"><b>Upload Gambar Objek Pajak *</b> :
                                <input class="btn btn-primary lam" type="file" name="txt_picture_sptpd" />
                            </div>
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr height="24" valign="top">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_sspd_2" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_sspd_2, 'lampiran_sspd_2') == '1' ? 'checked' : ''; ?>> Scan SPPT dan Seluruh Bukti/Print Out Pembayaran PBB<font color='red'>*</font> </label> </td>
                                            <td style="">
                                        ...
                                        <tr height="24" valign="top">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopi_identitas" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopi_identitas, 'lampiran_fotocopi_identitas') == '1' ? 'checked' : ''; ?>> Scan Identitas Wajib Pajaks<font color='red'>*</font> </label> </td>
                                            <td style="">
                                        ...
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_sertifikat_kepemilikan_tanah" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_sertifikat_kepemilikan_tanah, 'lampiran_sertifikat_kepemilikan_tanah') == '1' ? 'checked' : ''; ?>> Scan Sertifikat / Keterangan Kepemilikan<font color='red'>*</font></label> </td>
                                            <td style="">
                                        ...
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopy_surat_pernyataan" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopy_surat_pernyataan, 'lampiran_fotocopy_surat_pernyataan') == '1' ? 'checked' : ''; ?>> Scan Surat Pernyataan<font color='red'>*</font></label> </td>
                                            <td style="">
                                        ...
                                        <!-- //SPOPLSPOP -->
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_spoplspop" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_spoplspop, 'lampiran_spoplspop') == '1' ? 'checked' : ''; ?>> Formulir SPOP/LSPOP</label> </td>
                                            <td style="">
                                                <input type="file" name="txt_picture_spoplspop" class="lam" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr height="24">
                                            <td>
                                                ...
                                                <br>
                                                <input type="text" name="captcha" class="form-control" placeholder="Captcha" maxlength="6" id="captcha" />
                                            </td>
                                            <td class="va-bottom">
                                                <?php echo $cap; ?>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan='2' align='center'>Dengan menekan tombol "Simpan" saya menyatakan bahwa data yang diinput beserta lampiran yang diunggah benar dan sesuai dengan aslinya serta tidak dalam sengketa. Apabila ada permasalahan hukum dikemudian hari sepenuhnya menjadi tanggung jawab saya dan tidak melibatkan pejabat yang menandatangani SSPD-BPHTB.</td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modalFormLSPOP" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center" id="exampleModalLabel">Lampiran Surat Pemberitahuan Objek Pajak (LSPOP)</h5>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <button type="button" class="btn btn-primary btn-back pull-right btn-lg w-100 mt-10 disabled">
                                                ‹‹ Bangunan Sebelumnya</button>
                                        </div>
                                        <div class="col-sm-4">
                                            <button type="button" class="btn btn-success btn-simpan pull-right btn-lg w-100 mt-10 disabled"><i class="fa fa-save"></i> Simpan</button>
                                        </div>
                                        <div class="col-sm-4">
                                            <button type="button" class="btn btn-primary btn-next pull-right btn-lg w-100 mt-10 disabled">Bangunan Selanjutnya ››</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <script type="text/javascript">
                        ...
                        function harga_transaksi_change() {
                            ...
                            // if (jns_perolehan_op_id == '07' || jns_perolehan_op_id == '08') {
                        ...
                        function lookup_kabupaten_text() {
                            ...
                            var string2 = $('#propinsi_nik_id_text').select2('data');
                            console.log($string2 + ' HAHAHA');
                            var string2 = string2[0].text;
                            var result = string2.split('-');
                            $('#propinsi_nik_id_inp').val(result[1]);
                            // console.log(string2);
                        ...
                        function lookup_kecamatan_text() {
                            ...
                            var string2 = $('#kotakab_nik_id_text').select2('data');
                            var string2 = string2[0].text;
                            var result = string2.split('-');
                            $('#kotakab_nik_id_inp').val(result[1]);
                            console.log(string);
                            if (string == '') {
                        ...
                        function lookup_kelurahan_text() {
                            ...
                            var string2 = $('#kecamatan_nik_id_text').select2('data');
                            var string2 = string2[0].text;
                            var result = string2.split('-');
                            $('#kecamatan_nik_id_inp').val(result[1]);
                            if (string == '') {
                        ...
                        function lookup_input_kel() {
                            var string2 = $('#kelurahan_nik_id_text').select2('data');
                            var string2 = string2[0].text;
                            var result = string2.split('-');
                            $('#kelurahan_nik_id_inp').val(result[1]);
                        }
                        ...
                        function get_list_history_pembayaran(nop) {
                            $.ajax({
                                ...
                                //index.php/web_service/getnopbphtb?nop=
                                url: "<?php echo base_url('index.php/web_service/gethistorynop?nop='); ?>" + nop,
                            }).done(function(hasil) {
                                if (hasil == '0') {
                                    $.ajax({
                                        //url: "<?php echo $this->config->item('url_service_history_pembayaran_2'); ?>" + nop,
                                        url: "<?php echo base_url('index.php/web_service/gethistorynop2?nop='); ?>" + nop,
                                    }).done(function(hasil) {
                        ...
                        function lookup_nop(string, nik) {
                            $(".sel_jml_bangunan").prop("disabled", true);
                            if (nik == '') {
                                ...
                                if (string == '') {
                                    ...
                                    $.getJSON("<?php echo base_url('index.php/web_service/getnopbphtb?nop='); ?>" + string,
                                        function(response) {
                                            close_masking();
                                            console.log(response.RW_WP_SPPT);
                                            //console.log(response.KD_KECAMATAN);
                                            if (response.msg == 'Ada Data') {
                                                ...
                                                $(".sel_jml_bangunan").prop("disabled", false);
                                            } else {
                                                alert('NOP PBB tidak ditemukan!');
                        ...
                        <?php if ($submitvalue != 'Edit') : ?>
                            ...
                            $(document).ready(function() {
                                ...
                                $('.lam').change(function() {
                                    ...
                                    type = file.type;
                                    if (size > 3000000) {
                                        alert('Ukuran file maksimal 3 MegaByte');
                                        this.value = '';
                                    }
                                });
                        ...
                        function count_npoptkp(npoptkp) {
                            ...
                            var npopkp = npop - npoptkp;
                            var bea_perolehan = 0.05 * npopkp;
                            // var pengenaan50 = 0.5 * bea_perolehan;// var bea_bayar = pengenaan50;
                            var pengenaan50 = 0;
                    ...
                    <script>
                        var jml_bangunan = 1;
                        var lspopData = [];
                        var currentActiveFormBangunan = 1;
                        var lspopAttribute = {
                            "jenis_transaksi": [
                                "Perekaman Data",
                                "Pemutakhiran Data"
                            ],
                            "jenis_pembangunan_bangunan": [
                                "Perumahan",
                                "Perkantoran Swasta",
                                "Pabrik",
                            ...
                            "langit_langit": [
                                "Aksutik / Jati",
                                "Tripleks / Asbes Bambu",
                                "Tidak ada"
                            ]
                        }

                        $(document).ready(function(e) {
                            //GENERATE LSPOP DATA SEBANYAK JUMLAH OPTION DIDALAM ELEMEN .sel_jml_bangunan
                            for (var i = 1; i <= $(".sel_jml_bangunan option").length - 1; i++) {
                                lspopData[i - 1] = {
                                    "jenis_transaksi": 1,
                                    "bangunan_ke": i,
                                    "jenis_bangunan": 1,
                                    ...
                                    "tahun_direnovasi": new Date().getFullYear(),
                                    "daya_listrik": 0,
                                    "kondisi": 1,
                                    "konstruksi": 1,
                                    "atap": 1,
                            ...
                            $(".btn-showFormLSPOP").click(function(e) {
                                jml_bangunan = $(".sel_jml_bangunan").val();
                                loadForm(jml_bangunan);
                            });

                            $(".sel_jml_bangunan").change(function(e) {
                                showLSPOPForm();
                            });

                            function showLSPOPForm() {
                                jml_bangunan = parseInt($(".sel_jml_bangunan").val());
                                if (jml_bangunan > 0) {
                                    loadForm(jml_bangunan);
                                }
                            }

                            function loadForm(jml_bangunan) {
                                load_masking();
                                $.ajax({
                                    "url": "<?= base_url(); ?>index.php/sptpd/loadFormLSPOP",
                                    "method": "post",
                                    "data": {
                                        nop: $("input[name=txt_id_nop_sptpd]").val().replace(/\./g, ""),
                                        lspopData: JSON.stringify(lspopData),
                                        jml_bangunan: jml_bangunan,
                                    },
                                    success: function(e) {
                                        close_masking();
                                        $('#modalFormLSPOP').modal({
                                            backdrop: 'static'
                                        });
                                        $("#modalFormLSPOP .form-outer-wrapper").html(e);
                                        for (var i = 1; i <= jml_bangunan; i++) {
                                            parent = ".frm-bangunan" + i;
                                            generateSelection(parent, "jenis_transaksi", lspopAttribute.jenis_transaksi);
                                            generateSelection(parent, "jenis_pembangunan_bangunan", lspopAttribute.jenis_pembangunan_bangunan);
                                            generateSelection(parent, "kondisi_pada_umumnya", lspopAttribute.kondisi_pada_umumnya);
                                            generateSelection(parent, "konstruksi", lspopAttribute.konstruksi);
                                            generateSelection(parent, "atap", lspopAttribute.atap);
                                            generateSelection(parent, "dinding", lspopAttribute.dinding);
                                            generateSelection(parent, "lantai", lspopAttribute.lantai);
                                            generateSelection(parent, "langit_langit", lspopAttribute.langit_langit);
                                        }
                                    }
                                })
                            }

                            //MENGGENERATE FORM YANG MENGGUNAKAN RADIO BUTTON
                            function generateSelection(parent, indexName, array) {
                                element = parent + " ." + indexName + "_wrapper";
                                rdBtnName = "rd_" + indexName;
                                $(element).html("");
                                var html = '';
                                array.forEach(function(item, index) {
                                    var checked = (index == 0) ? 'checked' : '';
                                    html += '<label class="radio-inline"><input type="radio" name="' + rdBtnName + '" value="' + (index + 1) + '" ' + checked + '> ' + item + '</label>';
                                    if ((index + 1) % (parseInt(array.length / 2)) == 0) {
                                        html = "<div class='col-sm-6 no-margin'>" + html + "</div>";
                                        $(element).append(html);
                                        html = "";
                                    }
                                });
                                loadLastInputtedValue();
                            }
                        });
                    </script>
