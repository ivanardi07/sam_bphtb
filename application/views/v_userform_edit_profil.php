             ...
             <form class="form-horizontal" name="frm_rekening" method="post" action="">
                 <div class="panel panel-default" align="center">
                     <div class="panel-heading">
                         <!-- <h3 class="panel-title"><a href="<?php //echo $c_loc; 
                                                                ?>">User</a> &raquo; <?php //echo $submitvalue; 
                                                                                        ?></h3> -->
                     ...
                     <div class="panel-body">
                            ...
                            <div class="col-md-4 col-xs-12">                                                                                            
                             ...
                             <div class="form-group pt_id">
                                 ...
                                 <div class="col-md-4 col-xs-12">
                                     <div class="input-group">
                                         <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                         <input type="text" name="nama_wp" id="nama_id" style="width: 200px;" maxlength="100" value="<?php echo $this->antclass->back_value(@$user->nama, 'nama_wp');  ?>" readonly class="form-control" />
                                     </div>
                                 </div>
                             </div>
                             <div class="form-group pt_id">
                         ...
                         <?php if (@$user->tipe == 'PT') : ?>
                            ...
                            <div class="col-md-4 col-xs-12">                                                                                            
                                <div class="input-group">
                                    <span class="input-group-addon"><span class="fa fa-pencil"></span></span> -->
                             <input type="hidden" name="id_ppat" id="nama_id" style="width: 200px;" maxlength="100" value="<?php echo $this->antclass->back_value(@$user->id_ppat, 'id_ppat'); ?>" <?php if ($submitvalue == 'Edit') {
                                                                                                                                                                                                        echo 'disabled="disabled"';
                                                                                                                                                                                                    } ?> class="form-control id_input" />
                             <!-- </div>
