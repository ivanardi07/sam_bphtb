                        ...
                        <form enctype="multipart/form-data" name="frm_sptpd" method="post" action="" onsubmit="return check_add_sptpd();" id="frm_sptpd">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" id="tanggal_pengajuan_id_text" name="tanggal_pengajuan_name" style="width: 220px;" value="<?php echo $sptpd->tanggal ?>">
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <td> <span id="rtrw_nop_id"><?php echo @$nop_detail->rtrw_op; ?></span> </td>
                        ...
                        <td colspan = '4'>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" colspan="2">
                                                <?php if ($cek_transaksi_prev) : ?>
                                                    ...
                                                    <input type="text" name="txt_npoptkp_sptpd" id="npoptkp_id" value="<?php echo rupiah($this->config->item('conf_npoptkp_60')); ?>" onkeyup="count_npoptkp($(this).val());" />
                                                <?php else : ?>
                                                    Rp.&nbsp;&nbsp;<span id="npoptkp_lbl_id" hidden="">0</span>
                                                    <input type="text" name="txt_npoptkp_sptpd" style="width: 150px; text-align: right;" id="npoptkp_id" value="<?php echo rupiah(@$sptpd->npoptkp); ?>" class="form-control pull-right" readonly onkeyup="count_npoptkp($(this).val());" />
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <div style="margin: 10px 0;">
                                ...
                                <input class="form-control pull-left" type="text" name="txt_jml_setor_sptpd_text" id="txt_jml_setor_id" class="tb" style="width: 150px;text-align:right" maxlength="100" value="<?php echo $this->antclass->back_value(number_format(@$sptpd->jumlah_setor, 0, ',', '.'), 'txt_jml_setor_sptpd'); ?>" align="right" <?php if ($submitvalue == 'Edit') {
                                                                                                                                                                                                                                                                                                                                                        echo 'disabled="disabled"';
                                                                                                                                                                                                                                                                                                                                                    } ?> readonly />
                            ...
                            ?>
                            <div style="margin: 10px 0;"><b>Gambar Objek Pajak</b> : <?php if (!empty($sptpd->gambar_op)) { ?><div class="gambar_op"><img style="height:300px; width:300px;" src="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . $sptpd->gambar_op; ?>" /></div><?php } else {
                                                                                                                                                                                                                                                                                                                                echo '-';
                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                ?></div>
                            <?php // endif;
