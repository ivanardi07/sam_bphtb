                        ...
                        <form enctype="multipart/form-data" name="frm_sptpd" method="post" action="" onsubmit="return check_add_sptpd();" id="frm_sptpd">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td>
                                        <select id="propinsi_nik_id_text" name="propinsi_nik_name" class="form-control" onchange="lookup_kabupaten_text();" style="width: 220px;">
                                            <option value=""></option>
                                ...
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td>
                                        <select id="kotakab_nik_id_text" name="kotakab_nik_name" class="form-control" onclick="lookup_kecamatan_text();" style="width: 220px;">
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <select id="kecamatan_nik_id_text" name="kecamatan_nik_name" class="form-control" onclick="lookup_kelurahan_text();" style="width: 220px;">
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <select id="kelurahan_nik_id_text" name="kelurahan_nik_name" class="form-control" style="width: 220px;">
                                        </select>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr align="right">
                                            ...
                                            <td>
                                                <span style="display:none" id="luas_tanah_nop_id"><?php echo @$nop->luas_tanah_op; ?></span>
                                                <p class="pull-right">&nbsp;&nbsp;m<sup>2</sup></p><input class="form-control pull-right" onkeypress="return isNumberKey(event)" style="width: 100px;" type="text" name="txt_luas_tanah_sptpd" id="luas_tanah_id" onkeyup="count_tanah_add_sptpd_1();" value="<?php echo @$nop->luas_tanah_op; ?>" class="tb" />
                                            </td>
                                            <td>
                                                <span style="display:none" id="njop_tanah_nop_id"><?php echo number_format(@$nop->njop_tanah_op, 0, ',', '.'); ?></span>
                                                <input class="form-control pull-right" style="width: 150px;" readonly="readonly" type="text" name="txt_njop_tanah_sptpd" id="njop_tanah_id" value="<?php echo @$nop->njop_tanah_op; ?>" />
                                        ...
                                        <tr align="right">
                                            ...
                                            <td>
                                                <span style="display:none" id="luas_bangunan_nop_id"><?php echo @$nop->luas_bangunan_op; ?></span>
                                                <p class="pull-right">&nbsp;&nbsp;m<sup>2</sup></p><input class="form-control pull-right" onkeypress="return isNumberKey(event)" style="width: 100px;" type="text" name="txt_luas_bangunan_sptpd" id="luas_bangunan_id" onkeyup="count_bangunan_add_sptpd_1();" value="<?php echo @$nop->luas_bangunan_op; ?>" />
                                            </td>
                                            <td>
                                                <span style="display:none" id="njop_bangunan_nop_id"><?php echo number_format(@$nop->njop_bangunan_op, 0, ',', '.'); ?></span>
                                                <input class="form-control pull-right" style="width: 150px;" readonly="readonly" type="text" name="txt_njop_bangunan_sptpd" id="njop_bangunan_id" value="<?php echo @$nop->njop_bangunan_op; ?>" class="tb" />
                                                <p class="pull_right">Rp.&nbsp;&nbsp;</p>
                                            </td>
                                            <td align="right">
                                            ...
                                            <td colspan='4'>
                                                <div class="listform" style="margin: 10px 0;">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="4">
                                                                <center>REFERENSI HARGA PASAR :<center>
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <table class="table table-hover">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td colspan="2">
                                        <select id="jns_perolehan_op_id" name="txt_jns_perolehan_sptpd" class="tb" onchange="jenisAction ($(this).val());">
                                            <option value=""></option>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:350px;">
                                                <div id="npop_aphb">
                                                    <div class="row">
                                                        <div class="col-md-2"><input type="text" name="inp_aphb1" value="1" id="inp_aphb1" onchange="hitung_aphb ();" class="form-control input-aphb">
                                                        </div>
                                                        <div class="col-md-1 input-aphb"> / </div>
                                                        <div class="col-md-2"><input type="text" name="inp_aphb2" value="1" id="inp_aphb2" onchange="hitung_aphb ();" class="form-control input-aphb">
                                                        </div>
                                                        <div class="col-md-1 input-aphb"> x </div>
                                                        <div class="col-md-6"><input type="text" readonly="" name="inp_aphb3" value="1" id="inp_aphb3" class="form-control input-aphb">
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                            ...
                            <div style="margin: 10px 0;">
                                ...
                                <p class="pull-left">Rp.&nbsp;&nbsp;</p> <input class="form-control pull-left" type="text" name="txt_jml_setor_sptpd" id="jml_setor_id" class="tb" style="width: 150px;text-align:right" maxlength="100" value="<?php echo $this->antclass->back_value(@$sptpd->jumlah_setor, 'txt_jml_setor_sptpd'); ?>" align="right" <?php if ($submitvalue == 'Edit') {
                                                                                                                                                                                                                                                                                                                                                            echo 'disabled="disabled"';
                                                                                                                                                                                                                                                                                                                                                        } ?> readonly />
                                ...
                                <table class="table table-hover">
                                    <?php if ($submitvalue != 'Edit') : ?>
                                        <tr hidden>
                                            ...
                                            <td width="10"> : </td>
                                            <td>
                                                <select class="form-control" style="width: 100px" id="id_prefix_sptpd" name="txt_prefix_sptpd">
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr height="24" valign="top">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_sspd_2" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_sspd_2, 'lampiran_sspd_2') == '1' ? 'checked' : ''; ?>> Scan SPPT dan Seluruh Bukti Pembayaran/Print Out Pembayaran PBB </label> </td>
                                            <td style="">
                                        ...
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopy_akta_jb" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopy_akta_jb, 'lampiran_fotocopy_akta_jb') == '1' ? 'checked' : ''; ?>> Fotocopy Akta Jual Beli / Hibah / Waris</label> </td>
                                            <td style="">
                                        ...
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopy_keterangan_waris" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopy_kartu_npwp, 'lampiran_fotocopy_kartu_npwp') == '1' ? 'checked' : ''; ?>> Fotocopy Keterangan Waris</label> </td>
                                            <td style="">
                    ...
                    <script type="text/javascript">
                        ...
                        function harga_transaksi_change() {
                            ...
                            if (jns_perolehan_op_id == '07') {
                                ...
                                if (nilai_pasar > njop_pbb_nop_h_id) {
                        ...
                        function jenisAction(id_jenis) {
                            ...
                            if (id_jenis == '04' || id_jenis == '05') {
                                ...
                                $('#npoptkp_id').val('<?php echo $this->config->item('conf_npoptkp_49'); ?>');
                                ...
                                $('#npoptkp_id').val('<?php echo $this->config->item('conf_npoptkp_10'); ?>');
                                ...
                                $('#npoptkp_id').val('<?php echo $this->config->item('conf_npoptkp_60'); ?>');
