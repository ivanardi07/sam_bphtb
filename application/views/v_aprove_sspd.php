...
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span> SETUJUI SSPD</h2>
</div>
                        ...
                        <form name="frm_sptpd" method="post" action="">
                            <table class="table table-bordered table-hover">
                                ...
                                ?>
                                    ...
                                    <td>
                                            <a class=" btn btn-primary " href=" <?php echo base_url(); ?>index.php/aprove_sspd/lihat/<?php echo $user->id_sptpd; ?>">Lihat</a>
