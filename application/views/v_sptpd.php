...
<div class="page-title">
    <h2 style="display:block"><span class="fa fa-arrow-circle-o-left"></span> SSPD - BPHTB</h2>
    ...
    <!-- <p class="text-danger" style="clear: both;"><small>*Bug upload SPOP/LSPOP sudah diperbaiki.</small></p>
    <p class="text-danger" style="clear: both;"><small>*Bug tidak bisa edit ketika status DIKEMBALIKAN BAPENDA sudah diperbaiki.</small></p> -->
</div>
