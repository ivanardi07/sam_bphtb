                            ...
                            <div style="margin: 10px 0;">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr height="24" valign="top">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopi_identitas" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopi_identitas, 'lampiran_fotocopi_identitas') == '1' ? 'checked' : ''; ?>> Scan Identitas Wajib Pajak<font color='red'>*</font> </label> </td>
                                            <td style="">
