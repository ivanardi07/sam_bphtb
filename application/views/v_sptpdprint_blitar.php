...
<style type="text/css">
    ...
    div.detail_rejek_bg {
        ...
        top: 0;
        position: absolute;
        background-image: url(http://localhost/bphtb/assets/images/bg-info-rinci-pembayaran.jpg);
        background-size: 100%;
        filter: opacity(0.7);
    }
...
<div class="page-title">
    ...
    <?php if ($this->session->flashdata('info')) : ?>
        <?php if ($this->session->flashdata('info')["status"]) : ?>
            <div class="alert alert-success alert-dismissible" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <strong>Success!</strong> <?= $this->session->flashdata('info')["msg"] ?>
            </div>
        <?php else : ?>
            <div class="alert alert-danger alert-dismissible" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <strong>Gagal!</strong> <?= $this->session->flashdata('info')["msg"] ?>
            </div>
        <?php endif; ?>
    <?php endif; ?>
...
<div class="page-content-wrap">
    <div class="row">
        ...
        if ($sptpd->proses == '2'  && $jabatan == '2' && $sptpd->is_lunas == '1') {
        ...
        <form name="frm_cek_dinas" method="post" action="<?php echo site_url('sptpd/proses_validasi/' . $type) ?>">
            ...
            <div class="col-md-2">
                ...
                <?php
                //if ($sptpd->proses == '2' && $sptpd->batas < '3' ) {
                ?>

                <?php if ($sptpd->proses == '2' and (int)$sptpd->is_lunas == 2) : ?>
                    <?php if ($type == 'WP' || $type == 'PT' || $type == 'D') : ?>
                        <a class="btn btn-default" style="margin-left:18px;" href="<?= site_url('print_pdf/sspdbphtbsigned/' . $this->uri->segment(3)) ?>" target="_blank">
                            <i class="fa fa-print"></i> CETAK SSPD
                        </a>
                    <?php endif; ?>
                <?php else : ?>
                    <a class="btn btn-default" style="margin-left:18px;" href="#myModalInfoPembayaran" data-toggle="modal" onclick="detail(<?= $sptpd->id_sptpd ?>)">
                        <i class="fa fa-print"></i> CETAK INFO TAGIHAN
                    </a>
                <?php endif; ?>
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <?php if ($type == 'D') { ?>
                                ...
                                <?php } elseif ($sptpd->proses == '2'  && $jabatan == ((int)$sptpd->proses) && $sptpd->is_lunas == '1') { ?>
                                    <a class="btn btn-success" onclick="input_nik_passphrase()" data-toggle="modal">Validasi TTE</a>
                                <?php } else { ?>
                                    <?php if ($sptpd->proses == '0') {
            ...
            <div class="col-md-4">
                <table class="table">
                    <?php if ($sptpd->proses == '2') { ?>
                        <tr>
                            <td width="100"> ID Billing Bank Jatim</td>
                            <td width="10"> : </td>
                            <!-- <td> <?php echo idbilling(@$sptpd->no_dokumen); ?> </td> -->
                            <td> <?php echo @$sptpd->idbilling; ?> </td>
                        </tr>
                        <tr>
                            <td width="100"> Virtual Account Bank Jatim</td>
                            <td width="10"> : </td>
                            <td> <?php echo @$sptpd->va_jatim; ?> </td>
                        </tr>
                    <?php } else {
                    } ?>
                    <tr>
                    ...
                    <?php if ($type == 'D') : ?>
                        <?php
                        $label_button = (@$sptpd->hasil_verifikasi == "") ? "Input" : "Edit";
                        $label_button_class = (@$sptpd->hasil_verifikasi == "") ? "btn-success" : "btn-primary";
                        ?>
                        <tr>
                            <td colspan="3"><button type="button" class="btn <?= $label_button_class ?> btn-input-hasil-verifikasi"><?= $label_button ?> Hasil Verifikasi</button></td>
                        </tr>
                    <?php endif ?>
                    <!--
                        <tr>
                ...
                <td colspan="4">
                    <table class="table noborder">
                        <tr>
                            ...
                            <td>:</td>
                            <td colspan="7"><?php echo @$nik->nama . " " . @$sptpd->wajibpajak; ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>2. NIK</td>
                                ...
                                <table class="table tbl_perhitungan_njop">
                                    ...
                                    <tr>
                                        <td style="border:none!important" colspan="3">15. Jenis perolehan hak atas tanah dan atau bangunan
                                            <span><?php
                                                    if (@$sptpd->ptsl == 1) {
                                                        $ptsl = "<b><font color='red'>(PTSL)</font></b>";
                                                    } else {
                                                        $ptsl = "";
                                                    }

                                                    echo @$sptpd->jenis_perolehan . ' - ' . $nama . ' ' . $ptsl;
...
<div class="modal fade" id="myModalInfoPembayaran" tabindex="-1" role="dialog" aria-labelledby="myModalInfoPembayaranLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalInfoPembayaranLabel">Info Rinci Tagihan</h4>
            </div>
            <div class="modal-body">
                <div class="detail_rejek_bg"></div>
                <div class="detail_rejek"></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-unduh-info-rinci"><i class="fa fa-download"></i>UNDUH INFO RINCI</button>
...
<?php if ($sptpd->proses == '2'  && $jabatan == '2' && $sptpd->is_lunas == '1') : ?>
    <style>
    ...
    <div class="modal fade" id="myModalInputNIKdanPassphrase" tabindex="-1" role="dialog" aria-labelledby="myModalInputNIKdanPassphraseLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" class="form-horizontal" id="form_validasi_akhir_tte" action="<?= site_url('sptpd/proses_validasi_akhir/' . $this->uri->segment(3)) ?>">
                    <div class="modal-body">
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary btn-proses-tte"><i class="fa fa-download"></i>PROSES TTE</button>
    ...
    <script>
        $(".btn-proses-tte").click(function(e) {
            if ($("#passphrase_tte").val() == "") {
                alert("Masukkan Passphrase Anda Untuk Melakukan Tanda Tangan Secara Digital!");
                return false;
            } else {
                return true;
            }
...
<?php if ($type == 'D') : ?>
    <style>
        @media (min-width: 768px) {
            #myModalInputHasilVerifikasi .modal-dialog {
                width: 756px;
                margin: 30px auto;
            }
        }
    </style>
    <!-- Modal Input Hasil Verifikasi BPHTB -->
    <div class="modal fade" id="myModalInputHasilVerifikasi" tabindex="-1" role="dialog" aria-labelledby="myModalInputHasilVerifikasiLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalInputHasilVerifikasiLabel"><?= strtoupper($label_button) ?> HASIL VERIFIKASI BPHTB</h4>
                </div>
                <form method="post" class="form-horizontal" id="form_hasil_verifikasi_bphtb" action="<?= site_url('sptpd/simpan_verifikasi_bphtb/' . $this->uri->segment(3)) ?>" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <input class="form-control" type="hidden" id="no_dokumen" name="no_dokumen" value="<?= str_replace(".", "", @$sptpd->no_dokumen); ?>" readonly>
                            <label for="verifikasi_no_pelayanan" class="col-sm-2 control-label">No. Pelayanan</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="verifikasi_no_pelayanan" name="verifikasi_no_pelayanan" value="<?= @$sptpd->no_pelayanan; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_nama_wp" class="col-sm-2 control-label">Nama WP</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="verifikasi_nama_wp" name="verifikasi_nama_wp" value="<?= @$nik->nama . " " . @$sptpd->wajibpajak; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_alamat_op" class="col-sm-2 control-label">Alamat OP</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="verifikasi_alamat_op" name="verifikasi_alamat_op" value="<?= @$sptpd->nop_alamat; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_luas_bumi" class="col-sm-2 control-label">Luas Bumi m<sup>2</sup></label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="verifikasi_luas_bumi" name="verifikasi_luas_bumi" value="<?= @$sptpd->tanah_inp_aphb3; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_luas_bangunan" class="col-sm-2 control-label">Luas Bangunan m<sup>2</sup></label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="verifikasi_luas_bangunan" name="verifikasi_luas_bangunan" value="<?= @$sptpd->bangunan_inp_aphb3; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_luas_bumi_bersama" class="col-sm-2 control-label">Luas Bumi Bersama m<sup>2</sup></label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="verifikasi_luas_bumi_bersama" name="verifikasi_luas_bumi_bersama" value="0" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_luas_bangunan_bersama" class="col-sm-2 control-label">Luas Bangunan Bersama m<sup>2</sup></label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="verifikasi_luas_bangunan_bersama" name="verifikasi_luas_bangunan_bersama" value="0" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_njop" class="col-sm-2 control-label">NJOP (Rp.)</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="verifikasi_njop" name="verifikasi_njop" value="<?= number_format(@$sptpd->njop_pbb_op, 0, ',', '.'); ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_harga_transaksi" class="col-sm-2 control-label">Harga Transaksi (Rp.)</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="verifikasi_harga_transaksi" name="verifikasi_harga_transaksi" value="<?= number_format(@$sptpd->njop_pbb_op, 0, ',', '.'); ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_hasil" class="col-sm-2 control-label">Hasil</label>
                            <div class="col-sm-10">
                                <?php
                                $checked_hasil = 1;
                                if (@$sptpd->hasil_verifikasi != "" and @$sptpd->hasil_verifikasi == "Berkas Lengkap") {
                                    $checked_hasil = 1;
                                } elseif (@$sptpd->hasil_verifikasi != "") {
                                    $checked_hasil = 2;
                                }
                                ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="verifikasi_hasil" id="flexRadioDefault1" value="hasil1" <?= ($checked_hasil == 1) ? "checked" : "" ?>>
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Berkas Lengkap
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="verifikasi_hasil" id="flexRadioDefault2" value="hasil2" <?= ($checked_hasil == 2) ? "checked" : "" ?>>
                                    <label class="form-check-label" for="flexRadioDefault2" style="width:95%">
                                        <textarea class="form-control verifikasi_hasil_custom" name="verifikasi_hasil_custom" for="flexRadioDefault2"><?= ($checked_hasil == 2) ? @$sptpd->hasil_verifikasi : "" ?></textarea>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_lhp_verlap" class="col-sm-2 control-label">LHP Verlap</label>
                            <div class="col-sm-7">
                                <input class="form-control" type="file" id="verifikasi_lhp_verlap" name="verifikasi_lhp_verlap" accept=".jpg,.pdf">
                            </div>
                            <div class="col-sm-3"><?= (@$lhp_verlap_file_exist != "") ? '<a onclick="window.open(\'' . base_url('assets/files/penelitian/' . str_replace(".", "", $sptpd->no_dokumen) . '/' . @$lhp_verlap_file_exist) . '\', \'cetak\', \'status=0, title=0, height=500px, width=500px, scrollbars=1\')">' . @$lhp_verlap_file_exist . '</a>' : "Kosong" ?></div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_lampiran_lain" class="col-sm-2 control-label">Lampiran Lain-Lain</label>
                            <div class="col-sm-7">
                                <input class="form-control" type="file" id="verifikasi_lampiran_lain" name="verifikasi_lampiran_lain" accept=".jpg,.pdf">
                            </div>
                            <div class="col-sm-3"><?= (@$lampiran_lain_file_exist != "") ? '<a onclick="window.open(\'' . base_url('assets/files/penelitian/' . str_replace(".", "", $sptpd->no_dokumen) . '/' . @$lampiran_lain_file_exist) . '\', \'cetak\', \'status=0, title=0, height=500px, width=500px, scrollbars=1\')">' . @$lampiran_lain_file_exist . '</a>' : "Kosong" ?></div>
                        </div>
                        <div class="form-group">
                            <label for="verifikasi_tanggal_verifikasi" class="col-sm-2 control-label">Tanggal Verifikasi</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="verifikasi_tanggal_verifikasi" name="verifikasi_tanggal_verifikasi" value="<?= (@$sptpd->tgl_verifikasi != "") ? @$sptpd->tgl_verifikasi : date("Y-m-d") ?>">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary btn-simpan-hasil-verifikasi"><i class="fa fa-download"></i>SIMPAN</button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                    </div>
                </form>
            </div>
    ...
    <script>
        $(".btn-input-hasil-verifikasi").click(function(e) {
            $("#myModalInputHasilVerifikasi").modal();
        });

        $("#verifikasi_tanggal_verifikasi").datepicker({
            dateFormat: "yy-mm-dd", // Format tanggal Y-m-d
            maxDate: new Date() // Maksimal pilihan tanggal adalah tanggal saat ini
        });

        $(".verifikasi_hasil_custom").on("focus", function(e) {
...
<script type="text/javascript">
    ...
    function detail(id_sptpd) {
        $.ajax({
            ...
            $('.detail_rejek h3').html("Rincian Tagihan");
            $(".copy-va").off();
            $(".copy-va").click(function(e) {
                copyToClipboard($(".va")[0]);
            });
        });
    }

    $(".btn-unduh-info-rinci").click(function(e) {
        var el = $("#myModalInfoPembayaran .modal-body");
        captureScreenshotAsBlob(el);
    });

    function captureScreenshot(el) {
        // Mendapatkan elemen yang ingin diambil tangkapan layarnya
        $(".btn-screenshot").hide();

        var element = el[0];

        // Menggunakan html2canvas untuk mengambil tangkapan layar
        html2canvas(element).then(function(canvas) {
            // Mengubah tangkapan layar menjadi gambar dalam format PNG
            canvas.toBlob(function(blob) {
                ...
                navigator.clipboard.write([
                    ...
                    $(".btn-screenshot").show();
                    alert("Tangkapan layar berhasil disalin ke clipboard");
                }).catch(function(error) {
                    $(".btn-screenshot").show();
                    alert("Gagal menyalin tangkapan layar ke clipboard:", error);
                });
            }, "image/png");
        });
    }

    function captureScreenshotAsBlob(el) {
        // Mendapatkan elemen yang ingin diambil tangkapan layarnya
        $(".btn-screenshot").hide();
        ...
        html2canvas(element).then(function(canvas) {
            ...
            canvas.toBlob(function(blob) {
                ...
                a.href = url;
                a.download = 'rincian_pembayaran_bphtb_' + Date.now() + '.png'; // Nama file yang akan diunduh
                document.body.appendChild(a);
                a.click();

                // Membersihkan elemen link setelah digunakan
                document.body.removeChild(a);
                URL.revokeObjectURL(url);

                $(".btn-screenshot").show();
                // alert("Tangkapan layar berhasil diunduh");
            }, "image/png");
        });
    }
    ...
    <?php if ($sptpd->proses == '2'  && $jabatan == '2' && $sptpd->is_lunas == '1') : ?>
        ...
        function input_nik_passphrase() {
            $("#myModalInputNIKdanPassphrase").modal();
        }
    <?php endif ?>
</script>
