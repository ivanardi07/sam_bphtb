        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                        ...
                        <form enctype="multipart/form-data" name="frm_sptpd" method="post" action="" onsubmit="return check_add_sptpd();" id="frm_sptpd">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" class="form-control" id="tanggal_pengajuan_id_text" name="tanggal_pengajuan_name" style="width: 220px;" value="<?php echo $sptpd->tanggal ?>">
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <span id="kelurahan_nik_id"><?php echo @$nik->nm_kelurahan; ?></span>
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td width="25">: </td>
                                    <td>
                                        <input class="form-control pull-left" type="text" name="txt_id_nop_sptpd" onchange="lookup_nop($(this).val(), $('#id_nik_id').val());" id="nop_id" style="width: 220px;" value="<?php echo $nop; ?>" <?php if ($submitvalue == 'Edit') {
                                                                                                                                                                                                                                                    echo 'disabled="disabled"';
                                                                                                                                                                                                                                                } ?> class="tb" />
                                        <?php if ($submitvalue != 'Edit') { ?><a style="float: left; margin-left: 10px;" class="btn btn-default" href="javascript:void()" onclick="lookup_nop($(this).val(), $('#id_nik_id').val());" style="cursor:pointer">Detail</a> <b id="nop_error" style="background-color:#800;color:#fff;margin-left:20px;padding:0 10px;display:none"></b><?php } ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <textarea style="resize: vertical; width: 400px;" rows="5" class="form-control" id="alamat_nop_id" name="alamat_nop_id"><?php echo $sptpd->nop_alamat ?></textarea>
                                    </td>
                                </tr>
                                <!-- <tr>
                ...
                <tr>
                    <td> Alamat </td>
                    <td>: </td>
                    <td> <span id="alamat_nop_id"></span> </td>
                </tr>
               <tr>
                    <td> Kabupaten / Kota  </td>
                    <td>: </td>
                ...
                <tr>
                    <td> Kecamatan  </td>
                    <td>: </td>
                    <td> <span id="kecamatan_nop_id"><?php echo @$nop_detail->nm_kecamatan; ?></span> </td>
                </tr>
                <tr>
                    <td> Kelurahan  </td>
                    <td>: </td>
                    <td> <span id="kelurahan_nop_id"><?php echo @$nop_detail->nm_kelurahan; ?></span> </td>
                </tr>
                <tr>
                    <td> RT / RW  </td>
                    <td>: </td>
                    <td> <span id="rtrw_nop_id"><?php echo @$nop_detail->rtrw_op; ?></span> </td>
                </tr> -->
                            </table>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr class="tblhead">
                                            ...
                                            <th class="text-center" width="180"> Luas <br />(Diisi luas tanah dan atau bangunan yang haknya diperoleh)</th>
                                    ...
                                    <tbody>
                                        <tr align="right">
                                            ...
                                            <td>
                                                <div class="npop_aphb">
                                                    <div class="row">
                                                        <div class="col-md-3"><input type="text" name="tanah_inp_aphb1" value="<?php echo @$sptpd->tanah_inp_aphb1; ?>" id="tanah_inp_aphb1" onkeyup="count_tanah_add_sptpd_2();" class="form-control input-aphb" onkeypress="return isNumberKey(event)">
                                                        </div>
                                                        <div class="col-md-1 input-aphb"> / </div>
                                                        <div class="col-md-3"><input type="text" name="tanah_inp_aphb2" value="<?php echo @$sptpd->tanah_inp_aphb2; ?>" id="tanah_inp_aphb2" onkeyup="count_tanah_add_sptpd_2();" class="form-control input-aphb" onkeypress="return isNumberKey(event)">
                                                        </div>
                                                        <div class="col-md-1 input-aphb"> x </div>
                                                        <div class="col-md-3"><span style="display:none" id="luas_tanah_nop_id"><?php echo @$sptpd->luas_tanah_op; ?></span>
                                                            <input class="form-control pull-right" onkeypress="return isNumberKey(event)" type="text" name="txt_luas_tanah_sptpd" id="luas_tanah_id" onkeyup="count_tanah_add_sptpd_2();" value="<?php echo @$sptpd->luas_tanah_op; ?>" class="tb" style="width: 55px;" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <input type="text" readonly="" name="tanah_inp_aphb3" id="tanah_inp_aphb3" class="form-control input-aphb pull-left" style="width: 55px;" value="<?php echo @$sptpd->tanah_inp_aphb3; ?>">
                                                <div class="col-md-1 input-aphb"> x </div>
                                                <span style="display:none" id="njop_tanah_nop_id"><?php echo number_format(@$sptpd->njop_tanah_op, 0, ',', '.'); ?></span>
                                                <input class="form-control pull-right" style="width: 150px;" type="text" name="txt_njop_tanah_sptpd" id="njop_tanah_id" value="<?php echo number_format(@$sptpd->njop_tanah_op, 0, ',', '.'); ?>" onkeypress="return isNumberKey(event)" onkeyup="count_tanah_add_sptpd_2();" readonly />
                                                <p class="pull_right">Rp.&nbsp;&nbsp;</p>
                                            </td>
                                            <td align="right">
                                                Rp. <span id="l_njop_tanah_nop_id"><?php $ltnt = @$sptpd->luas_tanah_op * @$sptpd->njop_tanah_op;
                                                                                    echo number_format(@$ltnt, 0, ',', '.'); ?></span>
                                                <input type="hidden" name="txt_njop_tanah_nop_h_sptpd" id="l_njop_tanah_nop_h_id" value="<?php echo @$sptpd->luas_tanah_op * @$sptpd->njop_tanah_op; ?>" />
                                            </td>
                                        </tr>
                                        <tr align="right">
                                            ...
                                            <td>
                                                <div class="npop_aphb">
                                                    <div class="row">
                                                        <div class="col-md-3"><input type="text" name="bangunan_inp_aphb1" value="<?php echo @$sptpd->bangunan_inp_aphb1; ?>" id="bangunan_inp_aphb1" onkeyup="count_bangunan_add_sptpd_2();" class="form-control input-aphb" onkeypress="return isNumberKey(event)">
                                                        </div>
                                                        <div class="col-md-1 input-aphb"> / </div>
                                                        <div class="col-md-3"><input type="text" name="bangunan_inp_aphb2" value="<?php echo @$sptpd->tanah_inp_aphb2; ?>" id="bangunan_inp_aphb2" onkeyup="count_bangunan_add_sptpd_2();" class="form-control input-aphb" onkeypress="return isNumberKey(event)">
                                                        </div>
                                                        <div class="col-md-1 input-aphb"> x </div>
                                                        <div class="col-md-3"><span style="display:none" id="luas_bangunan_nop_id"><?php echo @$sptpd->luas_bangunan_op; ?></span>
                                                            <input class="form-control pull-right" onkeypress="return isNumberKey(event)" style="width: 55px;" type="text" name="txt_luas_bangunan_sptpd" id="luas_bangunan_id" onkeyup="count_bangunan_add_sptpd_2();" value="<?php echo @$sptpd->luas_bangunan_op; ?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <input type="text" readonly="" name="bangunan_inp_aphb3" id="bangunan_inp_aphb3" class="form-control input-aphb pull-left" style="width: 55px;" value="<?php echo @$sptpd->bangunan_inp_aphb3; ?>">
                                                <div class="col-md-1 input-aphb"> x </div>
                                                <span style="display:none" id="njop_bangunan_nop_id"><?php echo number_format(@$sptpd->njop_bangunan_op, 0, ',', '.'); ?></span>
                                                <input class="form-control pull-right" style="width: 150px;" type="text" name="txt_njop_bangunan_sptpd" id="njop_bangunan_id" value="<?php echo number_format(@$sptpd->njop_bangunan_op, 0, ',', '.'); ?>" class="tb" onkeypress="return isNumberKey(event)" onkeyup="count_bangunan_add_sptpd_2();" />
                                                <p class="pull_right">Rp.&nbsp;&nbsp;</p>
                                            </td>
                                            <td align="right">
                                                Rp. <span id="l_njop_bangunan_nop_id"><?php $lbnb = @$sptpd->luas_bangunan_op * @$sptpd->njop_bangunan_op;
                                                                                        echo number_format(@$lbnb, 0, ',', '.'); ?></span>
                                                <input type="hidden" name="txt_njop_bangunan_nop_h_sptpd" id="l_njop_bangunan_nop_h_id" value="<?php echo @$sptpd->luas_bangunan_op * @$sptpd->njop_bangunan_op; ?>" />
                                            </td>
                                        </tr>
                                        <tr align="right">
                                            ...
                                            <td>
                                                <div class="npop_aphb">
                                                    <div class="row">
                                                        <div class="col-md-3"><input type="text" name="tanah_b_inp_aphb1" value="<?php echo @$sptpd->tanah_b_inp_aphb1; ?>" id="tanah_b_inp_aphb1" onkeyup="count_tanah_b_add_sptpd_2();" class="form-control input-aphb" onkeypress="return isNumberKey(event)">
                                                        </div>
                                                        <div class="col-md-1 input-aphb"> / </div>
                                                        <div class="col-md-3"><input type="text" name="tanah_b_inp_aphb2" value="<?php echo @$sptpd->tanah_b_inp_aphb1; ?>" id="tanah_b_inp_aphb2" onkeyup="count_tanah_b_add_sptpd_2();" class="form-control input-aphb" onkeypress="return isNumberKey(event)">
                                                        </div>
                                                        <div class="col-md-1 input-aphb"> x </div>
                                                        <div class="col-md-3"><span style="display:none;" id="luas_tanah_b_nop_id"><?php echo @$sptpd->luas_tanah_b_op; ?></span>
                                                            <input class="form-control pull-right" onkeypress="return isNumberKey(event)" style="width: 55px;" type="text" name="txt_luas_tanah_b_sptpd" id="luas_tanah_b_id" onkeypress="return isNumberKey(event)" onkeyup="count_tanah_b_add_sptpd_2();" value="<?php echo @$sptpd->luas_tanah_b_op; ?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <input type="text" readonly="" name="tanah_b_inp_aphb3" id="tanah_b_inp_aphb3" class="form-control input-aphb pull-left" style="width: 55px;" value="<?php echo @$sptpd->tanah_b_inp_aphb3; ?>">
                                                <div class="col-md-1 input-aphb"> x </div>
                                                <span style="display:none;" id="njop_tanah_b_nop_id"><?php echo number_format(@$sptpd->njop_tanah_b_op, 0, ',', '.'); ?></span>
                                                <input class="form-control pull-right" style="width: 150px;" type="text" name="txt_njop_tanah_b_sptpd" id="njop_tanah_b_id" value="<?php echo @$sptpd->njop_tanah_b_op; ?>" class="tb" onkeyup="count_tanah_b_add_sptpd_2();" />
                                                <p class="pull_right">Rp.&nbsp;&nbsp;</p>
                                            </td>
                                            <td align="right">
                                                Rp. <span id="l_njop_tanah_b_nop_id"><?php $lbnb = @$sptpd->luas_tanah_b_op * @$sptpd->njop_tanah_b_op;
                                                                                        echo number_format(@$lbnb, 0, ',', '.'); ?></span>
                                                <input type="hidden" name="txt_njop_tanah_b_nop_h_sptpd" id="l_njop_tanah_b_nop_h_id" value="<?php echo @$sptpd->luas_tanah_b_op * @$sptpd->njop_tanah_b_op; ?>" />
                                            </td>
                                        </tr>
                                        <tr align="right">
                                            ...
                                            <td>
                                                <div class="npop_aphb">
                                                    <div class="row">
                                                        <div class="col-md-3"><input type="text" name="bangunan_b_inp_aphb1" value="<?php echo @$sptpd->bangunan_b_inp_aphb1; ?>" id="bangunan_b_inp_aphb1" onkeyup="count_bangunan_b_add_sptpd_2();" class="form-control input-aphb" onkeypress="return isNumberKey(event)">
                                                        </div>
                                                        <div class="col-md-1 input-aphb"> / </div>
                                                        <div class="col-md-3"><input type="text" name="bangunan_b_inp_aphb2" value="<?php echo @$sptpd->bangunan_b_inp_aphb1; ?>" id="bangunan_b_inp_aphb2" onkeyup="count_bangunan_b_add_sptpd_2();" class="form-control input-aphb" onkeypress="return isNumberKey(event)">
                                                        </div>
                                                        <div class="col-md-1 input-aphb"> x </div>
                                                        <div class="col-md-3"><span style="display:none;" id="luas_bangunan_b_nop_id"><?php echo @$sptpd->luas_bangunan_b_op; ?></span>
                                                            <input class="form-control pull-right" onkeypress="return isNumberKey(event)" style="width: 55px;" type="text" name="txt_luas_bangunan_b_sptpd" id="luas_bangunan_b_id" onkeypress="return isNumberKey(event)" onkeyup="count_bangunan_b_add_sptpd_2();" value="<?php echo @$sptpd->luas_bangunan_b_op; ?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <input type="text" readonly="" name="bangunan_b_inp_aphb3" id="bangunan_b_inp_aphb3" class="form-control input-aphb pull-left" style="width: 55px;" value="<?php echo @$sptpd->bangunan_b_inp_aphb3; ?>">
                                                <div class="col-md-1 input-aphb"> x </div>
                                                <span style="display:none;" id="njop_bangunan_b_nop_id"><?php echo number_format(@$sptpd->njop_bangunan_b_op, 0, ',', '.'); ?></span>
                                                <input class="form-control pull-right" style="width: 150px;" type="text" name="txt_njop_bangunan_b_sptpd" id="njop_bangunan_b_id" value="<?php echo @$sptpd->njop_bangunan_b_op; ?>" class="tb" onkeyup="count_bangunan_b_add_sptpd_2();" />
                                                <p class="pull_right">Rp.&nbsp;&nbsp;</p>
                                            </td>
                                            <td align="right">
                                                Rp. <span id="l_njop_bangunan_b_nop_id"><?php $lbnb = @$sptpd->luas_bangunan_b_op * @$sptpd->njop_bangunan_b_op;
                                                                                        echo number_format(@$lbnb, 0, ',', '.'); ?></span>
                                                <input type="hidden" name="txt_njop_bangunan_b_nop_h_sptpd" id="l_njop_bangunan_b_nop_h_id" value="<?php echo @$sptpd->luas_bangunan_b_op * @$sptpd->njop_bangunan_b_op; ?>" />
                                            </td>
                                        </tr>
                                        <tr align="center">
                                            <td colspan="3"></td>
                                            <td align="right">
                                                ...
                                                <input type="hidden" name="txt_njop_pbb_h_sptpd" id="njop_pbb_nop_h_id" value="<?php echo @$sptpd->njop_pbb_op; ?>" />
                                            </td>
                                        </tr>
                                        <!--                     <tr>
                        <td colspan = '4'>
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td width="25">: </td>
                                    <td>
                                        <p class="pull-left">Rp.&nbsp;&nbsp;</p> <input class="form-control pull-left" type="text" name="txt_nilai_pasar_sptpd" id="nilai_pasar_id" style="width: 150px; text-align: right;" maxlength="50" onkeyup="harga_transaksi_change();" value="<?php echo $this->antclass->back_value(rupiah(@$sptpd->nilai_pasar), 'txt_nilai_pasar_sptpd'); ?>" class="tb" />
                                        <p class="pull-left">&nbsp;&nbsp;*</p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td> <input type="text" style="width: 480px;" id="txt_no_sertifikat_op" name="txt_no_sertifikat_op" class="form-control pull-left" value="<?= $sptpd->no_sertifikat_op ?>"> </td>
                                </tr>
                            </table>
                            <div class="listform" style="margin: 10px 0;">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td align="right">
                                                ...
                                                <input class="form-control pull-right" type="text" name="txt_npop_sptpd" id="npop_id" style="width: 150px; text-align: right;" value="<?php echo $this->antclass->back_value(@$sptpd->npop, 'txt_npop_sptpd'); ?>" class="tb" readonly />
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" colspan="2">
                                                <?php if ($cek_transaksi_prev) : ?>
                                                    ...
                                                    <input type="text" name="txt_npoptkp_sptpd" id="npoptkp_id" value="<?php echo rupiah($this->config->item('conf_npoptkp_60')); ?>" onkeyup="count_npoptkp($(this).val());" readonly />
                                                <?php else : ?>
                                                    Rp.&nbsp;&nbsp;<span id="npoptkp_lbl_id" hidden="">0</span>
                                                    <input type="text" name="txt_npoptkp_sptpd" style="width: 150px; text-align: right;" id="npoptkp_id" value="<?php echo rupiah(@$sptpd->npoptkp); ?>" class="form-control pull-right" readonly onkeyup="count_npoptkp($(this).val());" readonly />
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <!-- Disable Update Hitung 0 error
					<tr>
                        ...
                        <td align="right" colspan="2">
                            Rp. <span id="npopkp_id">
                                <?php // $npopkp = @$sptpd->npop-@$sptpd->npoptkp;if ($npopkp <= 0) {$npopkp = 0;}
                            ...
                            <input type="hidden" name="txt_npopkp_sptpd" id="txt_npopkp_sptpd" value="0" />
                                        ...
                                        <!-- update untuk error hitung bea perolehan 0 error -->
                                        <tr>
                                            <td style="width: 360px;"> Nilai Perolehan Objek Pajak Kena Pajak (NPOPKP) </td>
                                            <td style="width: 100px; font-size: 10px;"> NPOP - NPOPTKP </td>
                                            <td align="right" colspan="2">
                                                ...
                                                <input type="hidden" name="txt_npopkp_sptpd" id="npopkp_h_id" value="<?php echo @$sptpd->npop - @$sptpd->npoptkp; ?>" />
                            ...
                            <div style="margin: 10px 0;">
                                ...
                                <input class="form-control pull-left" type="text" name="txt_jml_setor_sptpd_text" id="txt_jml_setor_id" class="tb" style="width: 150px;text-align:right" maxlength="100" value="
		<?php echo $this->antclass->back_value(number_format(@$sptpd->jumlah_setor, 0, ',', '.'), 'txt_jml_setor_sptpd'); ?>" align="right" <?php if ($submitvalue == 'Edit') {
                                                                                                                                                echo 'disabled="disabled"';
                                                                                                                                            } ?> readonly />
                                <!-- disable - Update Bea perolehan 0 error -->
                                <!-- <input class="form-control pull-left" type="hidden" name="txt_jml_setor_sptpd" id="jml_setor_id" class="tb" style="width: 150px;text-align:right" maxlength="100" value="
					<? php // echo $this->antclass->back_value(@$sptpd->jumlah_setor, 'txt_jml_setor_sptpd');
                    ?>" align="right" <?php // if ($submitvalue == 'Edit') {echo 'disabled="disabled"';} 
                                        ?> readonly /> -->

                                <!-- Update Bea perolehan 0 error -->
                                <input type="hidden" class="form-control pull-left" name="txt_jml_setor_sptpd" id="jml_setor_id" class="tb" style="width: 150px;text-align:right" maxlength="100" value="<?php
                                                                                                                                                                                                            $jumlah_setor = @$sptpd->jumlah_setor;
                                                                                                                                                                                                            if ($jumlah_setor == 0) {
                                                                                                                                                                                                                $jumlah_setor = '0';
                                                                                                                                                                                                            }
                                                                                                                                                                                                            echo $jumlah_setor; ?>" align="right" <?php if ($submitvalue == 'Edit') {
                                                                                                                                                                                                                                                        echo 'disabled="disabled"';
                                                                                                                                                                                                                                                    } ?> readonly />
                                <!-- end Update -->
                            ...
                            <div style="margin: 10px 0;"><b>Upload Gambar Objek Pajak</b> : <input class="btn btn-primary" type="file" name="txt_picture_sptpd" /></div>
                            <?php // if ($submitvalue == 'Edit' or $submitvalue == 'View'): 
                            ?>
                            <div style="margin: 10px 0;"><b>Gambar Objek Pajak</b> : <?php if (!empty($sptpd->gambar_op)) { ?><div class="gambar_op"><img style="width: 40%; height: auto;" src="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . $sptpd->gambar_op; ?>" /></div><?php } else {
                                                                                                                                                                                                                                                                                                                            echo '-';
                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                            ?></div>
                            <?php // endif;
                            ...
                            <tr height="24">
                                <td colspan=2 style="padding-left:20px"><strong>Nama Petugas Lapangan</strong>
                                    <div style="width:250px;"><input type="text" class="form-control" id="nama_petugas_lapangan" value="<?= $sptpd->nama_petugas_lapangan ?>" name="nama_petugas_lapangan" value=""></div>
                            </tr>
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr height="24" valign="top">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_sspd_2" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_sspd_2, 'lampiran_sspd_2') == '1' ? 'checked' : ''; ?>> Fotocopy SPPT dan STTS/Struk ATM bukti pembayaran PBB/Bukti Pembayaran PBB </label> </td>
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_sspd_2_file" />
                                                <?php if (!empty(@$file_upload->lampiran_sppt)) : ?>
                                                    <a target="_blank" href="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . @$file_upload->lampiran_sppt; ?>"><?php echo @$file_upload->lampiran_sppt; ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr height="24">
                                        <tr height="24" valign="top">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopi_identitas" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopi_identitas, 'lampiran_fotocopi_identitas') == '1' ? 'checked' : ''; ?>> Fotocopy Identitas Wajib Pajak </label> </td>
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_fotocopi_identitas_file" />
                                                <?php if (!empty(@$file_upload->lampiran_fotocopi_identitas)) : ?>
                                                    <a target="_blank" href="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . @$file_upload->lampiran_fotocopi_identitas; ?>"><?php echo @$file_upload->lampiran_fotocopi_identitas; ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <tr height="24">
                                        ...
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopy_identitas_kwp" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopy_identitas_kwp, 'lampiran_fotocopy_identitas_kwp') == '1' ? 'checked' : ''; ?>> Fotocopy Identitas Kuasa Wajib Pajak </label> </td>
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_fotocopy_identitas_kwp_file" />
                                                <?php if (!empty(@$file_upload->lampiran_fotocopy_identitas_kwp)) : ?>
                                                    <a target="_blank" href="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . @$file_upload->lampiran_fotocopy_identitas_kwp; ?>"><?php echo @$file_upload->lampiran_fotocopy_identitas_kwp; ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopy_kartu_npwp" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopy_kartu_npwp, 'lampiran_fotocopy_kartu_npwp') == '1' ? 'checked' : ''; ?>> Fotocopy kartu NPWP</label> </td>
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_fotocopy_kartu_npwp_file" />
                                                <?php if (!empty(@$file_upload->lampiran_fotocopy_kartu_npwp)) : ?>
                                                    <a target="_blank" href="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . @$file_upload->lampiran_fotocopy_kartu_npwp; ?>"><?php echo @$file_upload->lampiran_fotocopy_kartu_npwp; ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopy_akta_jb" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopy_akta_jb, 'lampiran_fotocopy_akta_jb') == '1' ? 'checked' : ''; ?>> Fotocopy Akta Jual Beli / Hibah / Surat Keterangan Waris / Hibah Wasiat</label> </td>
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_fotocopy_akta_jb_file" />
                                                <?php if (!empty(@$file_upload->lampiran_fotocopy_akta_jb)) : ?>
                                                    <a target="_blank" href="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . @$file_upload->lampiran_fotocopy_akta_jb; ?>"><?php echo @$file_upload->lampiran_fotocopy_akta_jb; ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_sertifikat_kepemilikan_tanah" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_sertifikat_kepemilikan_tanah, 'lampiran_sertifikat_kepemilikan_tanah') == '1' ? 'checked' : ''; ?>> Fotocopy Sertifikat / Keterangan Kepemilikan Tanah</label> </td>
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_sertifikat_kepemilikan_tanah_file">
                                                <?php if (!empty(@$file_upload->lampiran_sertifikat_kepemilikan_tanah)) : ?>
                                                    <a target="_blank" href="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . @$file_upload->lampiran_sertifikat_kepemilikan_tanah; ?>"><?php echo @$file_upload->lampiran_sertifikat_kepemilikan_tanah; ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopy_keterangan_waris" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopy_keterangan_waris, 'lampiran_fotocopy_keterangan_waris') == '1' ? 'checked' : ''; ?>> Fotocopy Keterangan Waris</label> </td>
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_fotocopy_keterangan_waris_file" />
                                                <?php if (!empty(@$file_upload->lampiran_fotocopy_keterangan_waris)) : ?>
                                                    <a target="_blank" href="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . @$file_upload->lampiran_fotocopy_keterangan_waris; ?>"><?php echo @$file_upload->lampiran_fotocopy_keterangan_waris; ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <tr height="24">
                                            <td> <label><input type="checkbox" value="1" id="" name="lampiran_fotocopy_surat_pernyataan" <?php echo $this->antclass->back_valuex(@$penelitian->lampiran_fotocopy_surat_pernyataan, 'lampiran_fotocopy_surat_pernyataan') == '1' ? 'checked' : ''; ?>> Fotocopy Surat Pernyataan</label> </td>
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_fotocopy_surat_pernyataan" />
                                                <?php if (!empty(@$file_upload->lampiran_fotocopy_surat_pernyataan)) : ?>
                                                    <a target="_blank" href="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . @$file_upload->lampiran_fotocopy_surat_pernyataan; ?>"><?php echo @$file_upload->lampiran_fotocopy_surat_pernyataan; ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr height="24">
                                            ...
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_spoplspop" />
                                                <?php if (!empty(@$file_upload->lampiran_spoplspop)) : ?>
                                                    <a target="_blank" href="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . @$file_upload->lampiran_spoplspop; ?>"><?php echo @$file_upload->lampiran_spoplspop; ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr height="24">
                                            ...
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_identitas_lainya_file" />
                                                <?php if (!empty(@$file_upload->lampiran_identitas_lainya)) : ?>
                                                    <a target="_blank" href="<?php echo base_url() . 'assets/files/penelitian/' . str_replace('.', '', $no_sspd) . '/' . @$file_upload->lampiran_identitas_lainya; ?>"><?php echo @$file_upload->lampiran_identitas_lainya; ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                        ...
                        <tr height="24" valign=top>
                            ...
                            <td style="">
                                ...
                                <div align="center">
                                    <input class="btn btn-primary" type="submit" name="submit" value="<?php echo $submitvalue; ?>" class="bt" id="save_tmp" />
                                    <input class="btn btn-danger" type="reset" name="reset" value="Reset" class="bt" />
                                    <input type="hidden" name="nomor_dokumen" value="<?php echo $sptpd->no_dokumen; ?>" />
                    ...
                    <script type="text/javascript">
                        ...
                        $(function() {
                            var com = [];
                            var availableTags = "<?= $sspd_no->no_dokumen ?>";
                            com.push(availableTags);
                            $("#skpdkb").autocomplete({
                                source: com
                            });
                        });
                        ...
                        function harga_transaksi_change() {
                            ...
                            //     $('#inp_aphb3').val(number_format(nilai_pasar_id));
                            //     hitung_aphb ();
                            // } else{
                        ...
                        function jenisAction(id_jenis) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?= site_url('sptpd/cek_progressif_kurang') ?>",
                                data: {
                                    nik: $('#id_nik_id').val(),
                                ...
                                var data = JSON.parse(cek);

                                var id_sptpd = <?php echo @$sptpd->id_sptpd ?>;
                                var npoptkp_data = <?php echo @$sptpd->npoptkp ?>;

                                if (data.length > 0) {
                                    if (data[0].id_sptpd == id_sptpd) {
                                        if (id_jenis == '04' || id_jenis == '05') {

                                            $('#npoptkp_id').val(number_format('<?php echo number_format($this->config->item('conf_npoptkp_300'), 0, ',', '.'); ?>'));
                                            $('#npoptkp_lbl_id').html(number_format('<?php echo number_format($this->config->item('conf_npoptkp_300'), 0, ',', '.'); ?>'));

                                            count_all(id_jenis);

                                        } else if (id_jenis == '14') {
                                            $('#npoptkp_id').val(number_format('<?php echo number_format($this->config->item('conf_npoptkp_49'), 0, ',', '.'); ?>'));
                                            ...
                                            $('#npoptkp_id').val(number_format('<?php echo number_format($this->config->item('conf_npoptkp_10'), 0, ',', '.'); ?>'));
                                            ...
                                            $('#npoptkp_id').val(number_format('<?php echo number_format($this->config->item('conf_npoptkp_60'), 0, ',', '.'); ?>'));
                                            ...
                                            $('#npoptkp_id').val(number_format('<?php echo number_format($this->config->item('conf_npoptkp_60'), 0, ',', '.'); ?>'));
                                            $('#npoptkp_lbl_id').html(number_format('<?php echo number_format($this->config->item('conf_npoptkp_60'), 0, ',', '.'); ?>'));
                                            // count_njop_sptpd($('#npop_id').val(), $('#npoptkp_id').val(), id_jenis, $('#id_nik_id').val());
                        ...
                        function hitung_aphb() {
                            ...
                            var s_inp_aphb3 = parseInt($('#inp_aphb3').val());

                            if (s_inp_aphb3 == '') {
                                var inp_aphb3 = 0;
                            } else {
                                var inp_aphb3 = s_inp_aphb3;
                            }

                            var total = (inp_aphb1 / inp_aphb2) * inp_aphb3;

                            // alert('Proses Perhitungan APHB');

                            // alert(inp_aphb1 + ' / ' + inp_aphb2 + ' * ' + inp_aphb3  + ' = ' + total);
                                ...
                                if (data.length > 0) {
                                    if (data[0].id_sptpd == id_sptpd) {
                                        if (jenis == '04') {
                                            ...
                                            $('#npoptkp_id').val('<?php echo $this->config->item('conf_npoptkp_300'); ?>');
                        ...
                        var aphb1 = "<?= $sptpd->inp_aphb1 ?>";
                        var aphb2 = "<?= $sptpd->inp_aphb2 ?>";
                        var aphb3 = "<?= $sptpd->inp_aphb3 ?>";

                        if (aphb1 != '0' && aphb2 != '0' && aphb3 != '0') {
                            $('#inp_aphb1').val(aphb1);
                            $('#inp_aphb2').val(aphb2);
                            $('#inp_aphb3').val(aphb3);
                            hitung_aphb();
                        ...
                        lookup_nik($('#id_nik_id').val());
                        // lookup_nop_new($('#nop_id').val(),$('#id_nik_id').val());
                        // jenisAction_v2 ($('#jns_perolehan_op_id').val());
                        ...
                        // if (jns_perolehan == '05') {
                        //     var npoptkp = "<?= @$sptpd->npoptkp ?>";
                        //     if (npoptkp != '') {
                        //         $('#npoptkp_id').val(number_format(npoptkp, 0, ',', '.'));
                        ...
                        function lookup_nop(string, nik) {
                            var nop_asal = '<?= $nop; ?>';
                            var edit = (string == nop_asal) ? true : false;
                                        ...
                                        function(response) {
                                            ...
                                            if (edit == true) {
                                                if (response.msg == 'Ada Data') {
                                                    var $rt = response.RT_WP_SPPT ? response.RT_WP_SPPT : '',
                                                    ...
                                                    $('#alamat_nop_id').html(response.JALAN_OP);
                                                    ...
                                                    // harga_transaksi_change();
                                                    harga_transaksi_change_v2();
                        ...
                        function lookup_nop_new(string, nik) {
                                ...
                                if (string == '') {
                                    ...
                                    $.getJSON("<?php echo $this->config->item('url_service_nop'); ?>web_service/getnopbphtb?nop=" + string,
                                        function(response) {
                                            close_masking();
                                            // console.log(response);
                                            if (response.msg == 'Ada Data' || response.msg == 'Sudah Ada') {
                                                var $rt = response.RT_WP_SPPT ? response.RT_WP_SPPT : '',
                                                    $rw = response.RW_WP_SPPT ? '/' + response.RW_WP_SPPT : '',
                                                    rt_rw = $rt + $rw;
                                                $('#status_pencarian_nop').val('dari sismiop');
                                                ...
                                                $('#npop_id').val(response.NJOP_SPPT);
                        ...
                        $('#npoptkp_id').on('keyup', function(event) {
                            $(this).mask("#.##0", {
                                reverse: true,
                                maxlength: false
                            });
                        ...
                        <?php if ($submitvalue != 'Edit') : ?>
                            ...
                            $(document).ready(function() {
                                jenisAction("<?= @$sptpd->jenis_perolehan; ?>");
                        ...
                        //custom
                        // function jenisAction_v2(id_jenis) {
                        ...
                        //             $('#npop_id').val(nilai_pasar);
                        //         } else {
                        //             nilai_yang_dipilih = njop_pbb_nop_h_id;
                        //             $('#npop_id').val(njop_pbb_nop_h_id);
                        //         }
                        //     } else {
                        //         nilai_yang_dipilih = njop_pbb_nop_h_id;
                        //         $('#npop_id').val(njop_pbb_nop_h_id);
                        ...
                        //     // var npoptkp = <?php echo @$sptpd->npoptkp ?>;

                        //     // $('#npoptkp_id').val(npoptkp);
                        //     // $('#npoptkp_lbl_id').html(npoptkp);

                        //     count_all_v2(id_jenis);
                        ...
                        function harga_transaksi_change_v2() {
                            var nilai_pasar_id = $('#nilai_pasar_id').val();
                            var nilai_pasar_arr = nilai_pasar_id.split('.');
                            var nilai_pasar = nilai_pasar_arr.join('');
                            ...
                            if (jns_perolehan_op_id == '08') {
                                ...
                                if (parseInt(nilai_pasar) > parseInt(njop_pbb_nop_h_id)) {
                                    $('#npop_id').val(number_format(nilai_pasar));
                                    // count_all_v2(jns_perolehan_op_id);
                                } else {
                                    $('#npop_id').val(number_format(njop_pbb_nop_h_id));
                                    // count_all_v2(jns_perolehan_op_id);
                                }
                        ...
                        //     count_all_v2(jns_perolehan);
                        // }

                        // function count_all_v2(jenis) {
                        //     var npop = parseInt($('#npop_id').val());
                        ...
                        //     var setor = <?php echo @$sptpd->jumlah_setor ?>;

                        //     if(bea_bayar > setor){
                        //         var bea_baru = bea_bayar - setor;
                        //         $('#kurang_bayar_id').html(number_format(bea_baru, 0, ',', '.'));
                        //         $('#kurang_bayar_h_id').val(bea_baru);
                        //     } else {
                        //         $('#kurang_bayar_id').html(0);
                        //         $('#kurang_bayar_h_id').val(0); 
                        //     }

                        //     terbilang_v2();
                        // }

                        // function terbilang_v2() {
                        //     var val = $('#jml_setor_id').val();
                        //     var huruf = $('#terbilang');

                        //     $.ajax({
                        //         url:'<?php echo base_url() ?>index.php/sptpd/terbilang_val',
                        //         data:{enValue:val,ajax:1},
                        //         type:'POST',
                        //         dataType:'json',
                        //         success: function(data) {
                        //             huruf.text('');
