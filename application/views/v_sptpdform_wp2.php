                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span id="nama_nik_id"><?php echo @$isi->nama; ?></span>
                                    </td>
                                </tr>
                                <tr>
                ...
                <tr>
                    ...
                    <td> <span id="rtrw_nop_id"><?php echo @$nop->rtrw_op; ?></span> </td>
                                    ...
                                    <tbody>
                                        <tr align="right">
                                            ...
                                            <td>
                                                ...
                                                <input class="form-control pull-right" style="width: 150px;" type="text" name="txt_njop_tanah_sptpd" id="njop_tanah_id" value="<?php echo @$nop->njop_tanah_op; ?>" onkeypress="return isNumberKey(event)" onkeyup="count_tanah_add_sptpd_2();" readonly />
                        ...
                        <td align="right" colspan="2">
                            ...
                            <input type="hidden" name="txt_npoptkp_sptpd" id="npoptkp_id" value="<?php echo $this->config->item('conf_npoptkp_60'); ?>" /> -->
                                                <?php else : ?>
                                                    <input class="form-control pull-right" type="text" name="txt_npoptkp_sptpd" id="npoptkp_id" style="width: 150px; text-align:right;" value="0" onkeyup="count_npoptkp($(this).val());">
                                                    <p class="pull-right">Rp.&nbsp;&nbsp;</p>
                                                    <!--                             Rp. <span id="npoptkp_lbl_id">0</span>
                            <input type="hidden" name="txt_npoptkp_sptpd" id="npoptkp_id" value="0" /> -->
                                                <?php endif; ?>
