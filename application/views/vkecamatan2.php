                    ...
                    <form class="form-inline" role="form" action="<?php echo site_url('kecamatan/index'); ?>" method="get">
                        <div class="form-group">
                            <div class="input-group">
                                <select class="form-control select2" style="width:160px;" name="propinsi" onchange="lookup($(this).val());">
                        ...
                        <div class="form-group">
                            <select class="form-control select2" id="dati2_id" name="kd_dati2" style="width:160px;">
                                ...
                                <?php foreach ($dati2s as $dati2) : ?>
                                    <option value="<?php echo $dati2->kd_kabupaten; ?>" <?= ($this->input->get('kd_dati2') == $dati2->kd_kabupaten) ? 'selected="selected"' : ''; ?>><?php echo $dati2->kd_kabupaten . ' - ' . $dati2->nama; ?></option>
                                <?php endforeach; ?>
