								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<div class="cols-sm-10">
											<div class="input-group">
												<?php
												$full_path = FCPATH . "assets/files/ktp/" . $user->foto;
