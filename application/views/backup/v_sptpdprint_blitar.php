                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_sspd != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_sspd); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_sspd ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_sppt != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_sppt); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_sppt ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_fotocopi_identitas != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_fotocopi_identitas); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_fotocopi_identitas ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_fotocopy_identitas_kwp != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_fotocopy_identitas_kwp); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_fotocopy_identitas_kwp ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_fotocopy_kartu_npwp != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_fotocopy_kartu_npwp); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_fotocopy_kartu_npwp ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_fotocopy_akta_jb != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_fotocopy_akta_jb); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_fotocopy_akta_jb ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_sertifikat_kepemilikan_tanah != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_sertifikat_kepemilikan_tanah); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_sertifikat_kepemilikan_tanah ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_fotocopy_keterangan_waris != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_fotocopy_keterangan_waris); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_fotocopy_keterangan_waris ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_fotocopy_surat_pernyataan != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_fotocopy_surat_pernyataan); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_fotocopy_surat_pernyataan ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_spoplspop != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_spoplspop); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_spoplspop ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if (@$penelitian->lampiran_identitas_lainya != '') : ?>
                                        <a onclick="window.open('<?php echo $no_dokumen_file_assets . $this->antclass->fix_name_file(@$penelitian->lampiran_identitas_lainya); ?>', 'cetak', 'status=0, title=0, height=500px, width=500px, scrollbars=1')"><?= @$penelitian->lampiran_identitas_lainya ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                        </table>
