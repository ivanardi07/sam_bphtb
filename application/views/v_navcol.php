...
<div class="page-sidebar">
    ...
    <ul class="x-navigation">
        ...
        <?php if ($akses == 'D' and $all_user['jabatan'] == '2') : ?>
            <li class="">
                <a href="<?php echo site_url(); ?>/validasi_tte"><span class="fa fa-pencil"></span>Validasi TTE SSPD
                    <span class="label label-warning notif" id="notif_tte">
                </a>
            </li>
        <?php endif ?>
        ...
        <?php if ($akses == 'D') : ?>
            <li class="">
                <a href="<?php echo site_url(); ?>/laporan_verifikasi"><span class="fa fa-file"></span>Laporan Verifikasi</a>
            </li>
        <?php endif ?>
...
<script type="text/javascript">
    ...
    function getNotif2() {
        $.ajax({
            url: "<?= site_url('sptpd/get_notif_jml_tte') ?>",
        }).done(function(hasil) {
            $('#notif_tte').html(hasil);
        }).error(function(e) {});
    }
</script>