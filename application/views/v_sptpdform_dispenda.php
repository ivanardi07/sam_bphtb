                        ...
                        <td align="right" colspan="2">
                            ...
                            <tr height="24">
                                <td colspan=2 style="padding-left:20px"><strong>Nama Petugas Lapangan</strong>
                                    <div style="width:250px;"><input type="text" class="form-control" id="nama_petugas_lapangan" name="nama_petugas_lapangan" value=""></div>
                            </tr>
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr height="24" valign="top" style="display:none">
                                            ...
                                            <td style="">
                                                <input type="file" name="txt_picture_lampiran_sspd_1_file" class="lam" />
                                            </td>
                                        </tr>
