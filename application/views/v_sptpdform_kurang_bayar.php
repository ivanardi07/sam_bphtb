        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="inputform">
                        <form enctype="multipart/form-data" name="frm_sptpd" method="post" action="<?php echo base_url(); ?>index.php/kurang_bayar/add" onsubmit="return check_add_sptpd_new();" id="frm_sptpd">
                            <div style="margin: 10px 0; border-bottom: 3px solid #CCC;"></div>
                            <input type="hidden" name="sspd_lama" value="<?php echo $id ?>">
                            <input type="hidden" name="id_ppat" value="<?php echo $sptpd->id_ppat ?>">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span id="nama_nik_id"><?php echo @$nik->nama; ?></span>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>: </td>
                                    <td> <span id="lokasi_nop_id"><?php echo @$nop_detail->lokasi_op; ?></span> </td>
                                </tr>
                                <tr>
                                    <td> Alamat </td>
                                    <td>: </td>
                                ...
                                <tr>
                                    <td> Kabupaten / Kota </td>
                                    <td>: </td>
                                    <td> <span id="kotakab_nop_id"><?php echo @$nop_detail->nm_dati2; ?></span> </td>
                                </tr>
                                <tr>
                                    <td> Kecamatan </td>
                                    <td>: </td>
                        ...
                        <td colspan = '4'>
                            <div class="listform" style="margin: 10px 0;">
                                ...
                                <div class="listform" style="margin: 10px 0;">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" colspan="2">
                                                    <?php if ($cek_transaksi_prev) : ?>
                                                        ...
                                                        <input type="text" name="txt_npoptkp_sptpd" id="npoptkp_id" value="<?php echo $this->config->item('conf_npoptkp_60'); ?>" onkeyup="count_npoptkp($(this).val());" />
                                                    <?php else : ?>
                                                        Rp.&nbsp;&nbsp;<span id="npoptkp_lbl_id" hidden="">0</span>
                                                        <input type="text" name="txt_npoptkp_sptpd" style="width: 150px; text-align: right;" id="npoptkp_id" value="<?= number_format(@$sptpd->npoptkp, 0, ',', '.') ?>" class="form-control pull-right" readonly onkeyup="count_npoptkp($(this).val());" />
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="2"> Bea Perolehan Hak atas Tanah dan Bangunan kurang bayar </td>
                                                <td align="right" colspan="2">
                                                    Rp. <span id="kurang_bayar_id">
                                                        <!--                                 <?php $bea_bayar = 0;
                                                                                                if ($pengenaan50 <= 0) {
                                                                                                    $bea_bayar = $npopkp5;
                                                                                                } else {
                                                    ...
                                                    <input type="hidden" name="txt_kurang_bayar_sptpd" id="kurang_bayar_h_id" value="<?php echo @$sptpd->kurang_bayar; ?>" />
                                                </td>
                                            </tr>
                                                ...
                                                <td align="right" colspan="2">
                                                    Rp. <span id="bea_bayar_id">
                                                        <!--                                 <?php $bea_bayar = 0;
                                                                                                ...
                                                                                                echo number_format(@$bea_bayar, 0, ',', '.'); ?> -->
                                                        <?php echo number_format(@$sptpd->jumlah_setor, 0, ',', '.'); ?>
                                                    </span> *
                                                    <input type="hidden" name="txt_bea_bayar_sptpd" id="bea_bayar_h_id" value="<?php echo @$bea_bayar; ?>" />
                                                </td>
                                            </tr>
                                            <tr style="display: none">
                                                <td colspan="2"> Bea Perolehan Hak atas Tanah dan Bangunan yang disetor</td>
                                                <td align="right" colspan="2">
                                                    Rp. <span id="sudah_setor_id"> <?= number_format(@$sptpd->jumlah_setor, 0, ',', '.') ?>
                                                        <!--                                 <?php $bea_bayar = 0;
                                                                                                if ($pengenaan50 <= 0) {
                                                                                                    $bea_bayar = $npopkp5;
                                                                                                } else {
                                                    ...
                                                    <!-- <input type="hidden" name="txt_sudah_setor_sptpd" id="sudah_setor_h_id" value="<?php echo @$sptpd->jml_setor; ?>" /> -->
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div style="margin: 10px 0;">
                                    ...
                                    <input class="form-control pull-left" type="text" name="txt_jml_setor_sptpd_txt" id="txt_jml_setor_id" class="tb" style="width: 150px;text-align:right" maxlength="100" value="<?php echo $this->antclass->back_value(@$sptpd->jumlah_setor, 'txt_jml_setor_sptpd'); ?>" align="right" <?php if ($submitvalue == 'Edit') {
                                                                                                                                                                                                                                                                                                                                echo 'readonly';
                                                                                                                                                                                                                                                                                                                            } ?> readonly />
                        ...
                        <tr height="24" valign=top>
                            ...
                            <td style="">
                                <textarea class="form-control" cols=50 rows=3 name="lampiran_identitas_lainya_val"><?php echo $this->antclass->back_valuex(@$penelitian->lampiran_identitas_lainya_val, 'lampiran_identitas_lainya_val'); ?></textarea>
                                    ...
                                    <div align="center">
                                        <input class="btn btn-primary" type="submit" name="submit" value="Simpan" class="bt" id="save_tmp" />
                            ...
                            $.ajax({
                                ...
                                if (data.length > 0) {
                                    ...
                                    if (id_jenis == '04' || id_jenis == '05') {
                                        ...
                                        $('#npoptkp_id').val('<?php echo number_format($this->config->item('conf_npoptkp_300'), 0, ',', '.'); ?>');
                                        $('#npoptkp_lbl_id').html('<?php echo number_format($this->config->item('conf_npoptkp_300'), 0, ',', '.'); ?>');

                                        count_all(id_jenis);

                                    } else if (id_jenis == '14') {
                                        $('#npoptkp_id').val('<?php echo number_format($this->config->item('conf_npoptkp_49'), 0, ',', '.'); ?>');
                                        $('#npoptkp_lbl_id').html('<?php echo number_format($this->config->item('conf_npoptkp_49'), 0, ',', '.'); ?>');


                                        count_all(id_jenis);

                                    } else if (id_jenis == '15') {
                                        $('#npoptkp_id').val('<?php echo number_format($this->config->item('conf_npoptkp_10'), 0, ',', '.'); ?>');
                                        $('#npoptkp_lbl_id').html('<?php echo number_format($this->config->item('conf_npoptkp_10'), 0, ',', '.'); ?>');


                                        count_all(id_jenis);

                                    } else if (id_jenis == '07') {
                                        $('#npoptkp_id').val('<?php echo number_format($this->config->item('conf_npoptkp_60'), 0, ',', '.'); ?>');
                                        $('#npoptkp_lbl_id').html('<?php echo number_format($this->config->item('conf_npoptkp_60'), 0, ',', '.'); ?>');
                                        var nilai_pasar_id = $('#nilai_pasar_id').val();
                                    ...
                                    $.getJSON("<?php echo $this->config->item('url_service_nop'); ?>web_service/getnopbphtb?nop=" + string,
                                        function(response) {
                                            ...
                                            if (response.msg == 'Ada Data') {
                                                ...
                                                $('#alamat_nop_id').html(response.JLN_WP_SPPT);
                                                ...
                                                $('#kelurahan_nop_id').html(response.KELURAHAN_WP_SPPT);
                                                $('#rtrw_nop_id').html(response.RT_WP_SPPT + '/' + response.RW_WP_SPPT);
                                                ...
                                                $('#idnopsave_kelurahan').val(response.KELURAHAN_WP_SPPT);
                                                $('#idnopsave_rtrw').val(response.RT_WP_SPPT + '/' + response.RW_WP_SPPT);
