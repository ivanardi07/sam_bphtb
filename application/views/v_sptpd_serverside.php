        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <table id="tabelsptpd" class="table table-striped table-bordered" style="width:100%;">
                    ...
                    <thead>
                        <tr class="tblhead">
                            <th class="text-center" style="width: 10px;">ID_SPTPD</th>
                            ...
                            <th class="text-center" style="width: 150px;">NOP Alamat OP</th>
                            ...
                            <th class="text-center" style="width: 150px;">APROVE</th>
                            <th class="text-center" style="width: 150px;">IS_LUNAS</th>
                            <th class="text-center" style="width: 150px;">PROSES</th>
                            <th class="text-center" style="width: 65px;">No. SSPD/Dokumen</th>
                        </tr>
                    </thead>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var table = $('#tabelsptpd').DataTable({
                ...
                //serverSide: true,
                ajax: {
                    url: "../assets/scripts/server_side/server_processing.php",
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        targets: 7,
                        render: function(data, type, row, meta) {
                            /*row 11 = is_lunas, row 10 = proses, row 9 = aprove ppat*/
                    ...
                    //                         'Desember'
                    //                     ];
                    //         var pecahkan = row[1].split('-');
                    //         var hasil = pecahkan[0]+' '+bulan[parseInt(pecahkan[1])]+' '+pecahkan[2];
                    //         console.log(hasil);
                    //         return hasil;
                    //     }
                    // },
