...
class Mod_register extends CI_Model
{
	public function get_prop($id_prop)
	{
		...
		$this->db->where("kd_propinsi", $id_prop);
	...
	public function get_kab($id_prov = '', $id_kab = '')
	{
		...
		$this->db->where("kd_propinsi", $id_prov);
		$this->db->where("kd_kabupaten", $id_kab);
	...
	public function get_kec($id_prov = '', $id_kab = '', $id_kec = '')
	{
		...
		$this->db->where("kd_propinsi", $id_prov);
		$this->db->where("kd_kabupaten", sprintf("%02d", $id_kab));
		$this->db->where("kd_kecamatan", sprintf("%03d", $id_kec));
	...
	public function get_kel($id_prov = '', $id_kab = '', $id_kec = '', $id_kel = '')
	{
		...
		$this->db->where("kd_kabupaten", sprintf("%02d", $id_kab));
		$this->db->where("kd_kecamatan", sprintf("%03d", $id_kec));
		$this->db->where("kd_kelurahan", sprintf("%03d", $id_kel));
	...
	public function get_kecamatan($prop, $kab)
	{
		...
		$this->db->where("kd_kabupaten", $kab);
	...
	public function acc_verifikasi($id)
	{
		...
		$data = $this->db->update('tbl_wp', $data);
